...
import { History, Shield, Users, Activity } from "lucide-react";
    ...
    return (
        <div className="p-4 md:p-6">
            <div className="mb-6">
                ...
                <p className="mt-1 text-gray-600 dark:text-gray-400">Manage platform logs and administrative staff.</p>
            </div>
                    ...
                    <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                logs.map((log) => (
                                    <tr key={log.id} className="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
